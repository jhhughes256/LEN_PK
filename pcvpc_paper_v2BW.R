...
# Build plot object
  ...
  p <- p + geom_point(aes(x = TADBIN, y = pcY*1000, group = MODEL), colour = "#999999", shape = 1)
  ...
  ggsave("pcvpc_paper_v2BW.png", width = 17.4, height = 23.4, units = c("cm"))
  ggsave("pcvpc_paper_v2BW.eps", width = 17.4, height = 23.4, units = c("cm"),
