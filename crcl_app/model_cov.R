# Define the model parameters and equations
  ...
  # Simulation uses RUN063_DES_1C8TAwAP_PPV_CORCLVKA_FFM as a base model
# ------------------------------------------------------------------------------
...
$PARAM  // Population parameters
	POPCL = 11.3,  // Clearance, L/h
	POPV1 = 74.9,  // Volume of central compartment, L
	POPKTR = 13.4,  // Absorption rate constant, h^-1

	// Covariate effects
	COV1 = 0.397,	// Effect of current smoking on clearance
...
$SIGMA  // Sigma
  block = FALSE
	...
	0.2500  // Proportional error combined
